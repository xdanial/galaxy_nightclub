...
TriggerEvent('esx_society:registerSociety', 'galaxy', 'Galaxy Nightclub', 'galaxy_nightclub', 'galaxy_nightclub', 'galaxy_nightclub', {type = 'private'})
...
AddEventHandler('esx_nightclub:getStockItem', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'galaxy_nightclub', function(inventory)
...
AddEventHandler('esx_nightclub:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'galaxy_nightclub', function(account)
...
ESX.RegisterServerCallback('esx_nightclub:getVaultWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'galaxy_nightclub', function(store)
